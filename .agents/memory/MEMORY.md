...
- [Gmail sending compatibility](gmail-sending-compatibility.md) — when Compose DOM isolation causes live Gmail regressions, prefer the proven legacy page-level flow.
...
- [GitHub push authentication](github-push-authentication.md) — when gh is authenticated but HTTPS push rejects credentials, run gh auth setup-git before retrying.